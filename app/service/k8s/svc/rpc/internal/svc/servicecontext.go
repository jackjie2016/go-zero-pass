...
import (
	...
	"go-zero-pass/app/service/k8s/svc/model/service"
...
type ServiceContext struct {
	...
	ModelService service.ISvcDataService
}
...
func NewServiceContext(c config.Config) *ServiceContext {
	...
	Service := service.NewSvcDataService(repository.NewSvcRepository(db), K8sClient)
	if err := Service.InitListFromK8s("default"); err != nil {
		logx.Errorw(logmessage.K8SError, logx.Field("Detail", err.Error()))
		return nil
	}
